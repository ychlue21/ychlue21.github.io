...
$rt=mysqli_query($koneksi,"SELECT * from ketua_Rt join warga on ketua_rt.nik=warga.nik join user on user.id_user=ketua_rt.iduser WHERE id_user = '$iduser'");
...
if (isset($_POST['submit'])) {   
    ...
    if (!$userData) {
        ...
        if (password_verify($old_password, $userData->password)) {
            ...
            // Jika password baru diisi dan sesuai konfirmasi
