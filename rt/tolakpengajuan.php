...
$statusSurat = ($statusRt === 'Ditolak') ? 'ditolak' : 'diproses';


    // Update status dan simpan keterangan ke database
    $update = mysqli_query($koneksi, "
        UPDATE berkaspengajuansuratkeluar 
        SET keterangan = '$keterangan' ,tanggalselesai='$tanggalselesai',status_rt = '$statusRt',konfirmasi_rt='$konfirmasi_Rt',is_viewed = 0,status_surat = '$statusSurat'
