...
$query = "SELECT WARGA.NIK, WARGA.NOKK, namalengkap, JK, alamat 
          FROM warga 
          JOIN rt ON warga.alamat LIKE CONCAT('%', rt.nama_rt, '%') 
          JOIN ketua_rt ON ketua_rt.idrt = rt.idrt 
          WHERE ketua_rt.iduser = '$iduser'";
...
$query .= " ORDER BY WARGA.Nokk ASC LIMIT $limit OFFSET $offset";
        ...
        <table class="table table-bordered border-dark">
            ...
            <tbody>
                ...
                <?php
                    ...
                    echo "<tr class='text-center'><td colspan='5'>TIDAK ADA DATA WARGA</td></tr>";
                }
                ?>
            </tbody>
        </table>
