...
$iduser = mysqli_real_escape_string($koneksi, $_SESSION['user_id']); // Sanitasi input untuk keamanan
...
$totalNotifikasiQuery = "SELECT COUNT(*) AS total FROM berkaspengajuansuratkeluar 
                    ...
                    WHERE ketua_rw.iduser = '$iduser' AND is_viewed = 0 and status_rt='Diproses'";
...
<head>
    ...
    function markAsViewed(idberkassurat) {
        // Mengirim permintaan AJAX untuk menandai notifikasi sebagai dilihat
        fetch('mark_as_viewed.php', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/x-www-form-urlencoded',
                },
                body: 'idberkassurat=' + idberkassurat
            })
            .then(response => response.json())
            .then(data => {
                if (data.success) {
                    // Mengurangi jumlah notifikasi
                    updateNotificationCount();
                } else {
                    console.error('Gagal menandai notifikasi sebagai dilihat');
                }
            })
    ...
    function updateNotificationCount() {
        // Mengurangi angka notifikasi di UI
        const notificationCountElement = document.getElementById(
            'notificationCount'); // Ganti ID sesuai dengan elemen Anda
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link" aria-current="page" href="rt.php">RT</a></li>
